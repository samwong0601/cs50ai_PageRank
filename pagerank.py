...
def sample_pagerank(corpus, damping_factor, n):
    ...
    pagerank = {page: count / total_samples for page, count in counts.items()}
    print("Sample-based PageRank:", pagerank)  # Debug print
...
def iterate_pagerank(corpus, damping_factor):
    ...
    while not convergence:
        ...
        for page in corpus:
            ...
            # Contributions from linked pages
            for p in corpus:
                if page in corpus[p]:
                    rank += damping_factor * (pagerank[p] / len(corpus[p]))
                elif not corpus[p]:
                    rank += damping_factor * (pagerank[p] / num_pages)
    ...
    print("Iterative PageRank:", pagerank)  # Debug print
